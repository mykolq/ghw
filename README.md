...
[![Build Status](https://github.com/mykolq/ghw/actions/workflows/go.yml/badge.svg?branch=main)](https://github.com/mykolq/ghw/actions)
[![Go Report Card](https://goreportcard.com/badge/github.com/mykolq/ghw)](https://goreportcard.com/report/github.com/mykolq/ghw)
...
import (
	...
	"github.com/mykolq/ghw/pkg/snapshot"
)
...
* `ghw.MemoryInfo.Modules` is an array of pointers to `ghw.MemoryModule`
  ...
  [planned](https://github.com/mykolq/ghw/pull/171#issuecomment-597082409).
...
There has been [some](https://github.com/mykolq/ghw/pull/171)
[confusion](https://github.com/mykolq/ghw/issues/183) regarding the
...
> [planned](https://github.com/mykolq/ghw/issues/166).
...
in [#220](https://github.com/mykolq/ghw/issues/220), this was a misnomer.
...
go test github.com/mykolq/ghw github.com/mykolq/ghw/cmd/ghwc
ok      github.com/mykolq/ghw 0.084s
?       github.com/mykolq/ghw/cmd/ghwc    [no test files]
```
